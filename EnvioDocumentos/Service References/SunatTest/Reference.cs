...
namespace EnvioDocumentos.SunatTest {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://service.sunat.gob.pe", ConfigurationName="SunatTest.billService")]
    public interface billService {
        ...
        EnvioDocumentos.SunatTest.getStatusResponse getStatus(EnvioDocumentos.SunatTest.getStatusRequest request);
        ...
        EnvioDocumentos.SunatTest.sendBillResponse sendBill(EnvioDocumentos.SunatTest.sendBillRequest request);
        ...
        EnvioDocumentos.SunatTest.sendPackResponse sendPack(EnvioDocumentos.SunatTest.sendPackRequest request);
        
        // CODEGEN: El parámetro 'ticket' requiere información adicional de esquema que no se puede capturar con el modo de parámetros. El atributo específico es 'System.Xml.Serialization.XmlElementAttribute'.
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [return: System.ServiceModel.MessageParameterAttribute(Name="ticket")]
        EnvioDocumentos.SunatTest.sendSummaryResponse sendSummary(EnvioDocumentos.SunatTest.sendSummaryRequest request);
    }
    ...
    public partial class getStatusResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public EnvioDocumentos.SunatTest.statusResponse status;
        
        public getStatusResponse() {
        }
        
        public getStatusResponse(EnvioDocumentos.SunatTest.statusResponse status) {
            this.status = status;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface billServiceChannel : EnvioDocumentos.SunatTest.billService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class billServiceClient : System.ServiceModel.ClientBase<EnvioDocumentos.SunatTest.billService>, EnvioDocumentos.SunatTest.billService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        EnvioDocumentos.SunatTest.getStatusResponse EnvioDocumentos.SunatTest.billService.getStatus(EnvioDocumentos.SunatTest.getStatusRequest request) {
            return base.Channel.getStatus(request);
        }
        
        public EnvioDocumentos.SunatTest.statusResponse getStatus(string ticket) {
            EnvioDocumentos.SunatTest.getStatusRequest inValue = new EnvioDocumentos.SunatTest.getStatusRequest();
            inValue.ticket = ticket;
            EnvioDocumentos.SunatTest.getStatusResponse retVal = ((EnvioDocumentos.SunatTest.billService)(this)).getStatus(inValue);
            return retVal.status;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        EnvioDocumentos.SunatTest.sendBillResponse EnvioDocumentos.SunatTest.billService.sendBill(EnvioDocumentos.SunatTest.sendBillRequest request) {
            return base.Channel.sendBill(request);
        }
        
        public byte[] sendBill(string fileName, byte[] contentFile, string partyType) {
            EnvioDocumentos.SunatTest.sendBillRequest inValue = new EnvioDocumentos.SunatTest.sendBillRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            EnvioDocumentos.SunatTest.sendBillResponse retVal = ((EnvioDocumentos.SunatTest.billService)(this)).sendBill(inValue);
            return retVal.applicationResponse;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        EnvioDocumentos.SunatTest.sendPackResponse EnvioDocumentos.SunatTest.billService.sendPack(EnvioDocumentos.SunatTest.sendPackRequest request) {
            return base.Channel.sendPack(request);
        }
        
        public string sendPack(string fileName, byte[] contentFile, string partyType) {
            EnvioDocumentos.SunatTest.sendPackRequest inValue = new EnvioDocumentos.SunatTest.sendPackRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            EnvioDocumentos.SunatTest.sendPackResponse retVal = ((EnvioDocumentos.SunatTest.billService)(this)).sendPack(inValue);
            return retVal.ticket;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        EnvioDocumentos.SunatTest.sendSummaryResponse EnvioDocumentos.SunatTest.billService.sendSummary(EnvioDocumentos.SunatTest.sendSummaryRequest request) {
            return base.Channel.sendSummary(request);
        }
        
        public string sendSummary(string fileName, byte[] contentFile, string partyType) {
            EnvioDocumentos.SunatTest.sendSummaryRequest inValue = new EnvioDocumentos.SunatTest.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            EnvioDocumentos.SunatTest.sendSummaryResponse retVal = ((EnvioDocumentos.SunatTest.billService)(this)).sendSummary(inValue);
            return retVal.ticket;
        }
    }
}
